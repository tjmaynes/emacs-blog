#+TITLE: Railway-oriented Programming using Kotlin/Spring WebFlux and Arrow Fx
#+DATE: <2019-12-20, Fri>
#+DESCRIPTION: In this blog, we'll be implementing a functional style of error handling called Railway-oriented programming in a modern Kotlin/Spring backend service.
